...
// OTP specific limiter - 5 requests per hour
...
// STK Push limiter - 10 requests per 10 minutes
    ...
    <body style="font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background-color: #0a0a0f; margin: 0; padding: 0; color: #f0eef8;">
      <div style="max-width: 580px; margin: 0 auto; padding: 40px 20px;">
        <div style="background: linear-gradient(135deg, #111118 0%, #17171f 100%); border-radius: 28px; padding: 32px; border: 1px solid rgba(224, 49, 49, 0.2); box-shadow: 0 25px 50px rgba(0,0,0,0.5);">
          ...
          <div style="background: #1e1e28; border-radius: 20px; padding: 20px; margin-bottom: 24px; border: 1px solid rgba(255,255,255,0.05);">
            <div style="display: flex; justify-content: space-between; margin-bottom: 16px; flex-wrap: wrap; gap: 12px;">
              <div><div style="font-size: 11px; color: #6b6780; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">Order Number</div><div style="font-size: 14px; font-weight: 600; color: #f0a500; font-family: monospace;">${orderId}</div></div>
              <div><div style="font-size: 11px; color: #6b6780; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">Order Date</div><div style="font-size: 14px; font-weight: 500; color: #c8c4d8;">${timestamp}</div></div>
              <div><div style="font-size: 11px; color: #6b6780; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">Payment Method</div><div style="font-size: 14px; font-weight: 500; color: #c8c4d8;">${paymentText}</div></div>
            </div>
            <div style="border-top: 1px solid rgba(255,255,255,0.06); padding-top: 16px;">
              <div style="font-size: 11px; color: #6b6780; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px;">Delivery Address</div>
              <div style="font-size: 14px; color: #c8c4d8; line-height: 1.4;">${escapeHtml(address)}</div>
          ...
          <div style="background: #1e1e28; border-radius: 20px; overflow: hidden; margin-bottom: 24px; border: 1px solid rgba(255,255,255,0.05);">
            <div style="background: #24242f; padding: 14px 20px; font-size: 13px; font-weight: 700; color: #f0a500; text-transform: uppercase; letter-spacing: 1px;">Order Summary</div>
            <table style="width: 100%; border-collapse: collapse;">
              <thead><tr style="border-bottom: 1px solid rgba(255,255,255,0.06);"><th style="padding: 14px 12px; text-align: left; font-size: 11px; color: #6b6780; font-weight: 600;">Item</th><th style="padding: 14px 12px; text-align: right; font-size: 11px; color: #6b6780; font-weight: 600;">Amount</th></tr></thead>
              <tbody>${itemsHtml}</tbody>
            </table>
          </div>
          <div style="background: #1e1e28; border-radius: 20px; padding: 20px; margin-bottom: 24px; border: 1px solid rgba(255,255,255,0.05);">
            <div style="display: flex; justify-content: space-between; margin-bottom: 12px;"><span style="color: #9994ad; font-size: 14px;">Subtotal</span><span style="color: #c8c4d8; font-size: 14px; font-weight: 500;">KES ${subtotal.toLocaleString()}</span></div>
            <div style="display: flex; justify-content: space-between; margin-bottom: 12px;"><span style="color: #9994ad; font-size: 14px;">Delivery Fee</span><span style="color: #c8c4d8; font-size: 14px; font-weight: 500;">${deliveryText}</span></div>
            <div style="display: flex; justify-content: space-between; padding-top: 16px; margin-top: 8px; border-top: 2px solid #e03131;"><span style="font-size: 18px; font-weight: 800; color: #e03131;">Total Amount</span><span style="font-size: 20px; font-weight: 800; color: #e03131;">KES ${total.toLocaleString()}</span></div>
          </div>
          <div style="background: linear-gradient(135deg, rgba(46,204,113,0.08), rgba(46,204,113,0.02)); border-radius: 20px; padding: 20px; text-align: center; border: 1px solid rgba(46,204,113,0.15); margin-bottom: 24px;">
            <div style="font-size: 32px; margin-bottom: 8px;">🚚</div>
            <div style="font-size: 15px; font-weight: 700; color: #2ecc71; margin-bottom: 6px;">Delivery in Progress</div>
